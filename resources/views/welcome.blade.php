...
<table class="table mt-3 w-75 m-auto">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form action="{{route('producto.destroy', $producto)}}" method="POST" id="formDelete">
                    @method("DELETE")
                    @csrf
                ...
                <a href="{{route('producto.edit', $producto)}}" class="btn btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="" style="width: 15px; height:15px">>
                        <path stroke-linecap="round" stroke-linejoin="round"
